<div class="section bg-primary" id="user-section">
  <div id="user-detail">
    <div class="avatar">
      <img src="<?= base_url() ?>/image/foto.jpeg" alt="avatar" class="imaged w86 rounded" />
    </div>
    <div id="user-info">
    ...
    <div class="card-body text-center">
      <div class="list-menu">
        ...
        <div class="item-menu text-center">
          ...
          <div class="menu-name">
            <a href="<?= base_url('Home/history') ?>">Histori</a>
          </div>
        </div>
        <div class="item-menu text-center">
          <div class="menu-icon">
...
<div class="section mt-2" id="presence-section">
          ...
          <div class="card-body">
            <div class="presencecontent">
              ...
              <div class="presencedetail">
                ...
                <span class="rekappresencedetail"><?= count($history) ?> Hari</span>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="presencetab mt-2">
    ...
    <div class="tab-content mt-2" style="margin-bottom: 100px">
      ...
      <div class="tab-content mt-2" style="margin-bottom:100px">
        <a href="<?= base_url('Auth/logout') ?>" class="btn btn-danger btn-block"><i class="fas fa-sign-out-alt"
            style="margin-right:0.5em"></i> Logout</a>
      </div>
    </div>
  </div>
</div>