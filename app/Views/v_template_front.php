...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url('font') ?>/assets/img/favicon.png" sizes="32x32" />
    ...
    <script src="<?= base_url('front') ?>/assets/js/plugins/jquery-circle-progress/circle-progress.min.js">
    </script>
        ...
        <a href="<?= base_url('Presensi') ?>" class="item">
            <div class="col">
                <div class="action-button large">
                    <i class="fas fa-camera text-white fa-2x <?= $menu == 'presensi' ? 'text-danger' : '' ?> "></i>
                    <span style="color:white; font-size: 10px; margin-left:.4rem">Absen</span>
                </div>
