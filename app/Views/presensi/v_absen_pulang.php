...
<div class="row" style="margin-top:70px">
    <div class="col">
        ...
        <button class="btn btn-danger btn-block btn-flat" id="takeAbsen"><i class="fas fa-camera"
                style="margin-right: 0.5em"></i>
            Absen Pulang</button>
        <input type="hidden" name="lokasi" id="lokasi">
        <div id="map" style="width:100%; height: 400px"></div>
        <audio src="<?=base_url('public/sound/absenpulang.mp3')?>" id="notifikasi_out" type="audio/mpeg"></audio>
